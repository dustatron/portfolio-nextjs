  ...
  return (
    <div className={s["header"]} id="top">
      ...
      <div className={s["header-links"]}>
        <a href="https://www.linkedin.com/in/dustymccord/" target="_blank" rel="noopener noreferrer">
          <LinkedinSVG className={s["header-links-icons"]} width={35} height={35} />
          {/* <img src='/media/icons/linkedin.svg' alt='linkedin' /> */}
        </a>
        <a href="https://github.com/dustatron" target="_blank" rel="noopener noreferrer">
          <GithubSVG className={s["header-links-icons"]} width={35} height={35} />
          {/* <img src='/media/icons/github-simple.svg' alt='github' /> */}
        </a>

        <a href="https://twitter.com/dustatron" target="_blank" rel="noopener noreferrer">
          <TwitterSVG className={s["header-links-icons"]} width={35} height={35} />
          {/* <img src='/media/icons/twitter.svg' alt='twitter' /> */}
        </a>
        <a href="mailto:dustymccord@gmail.com" target="_blank" rel="noopener noreferrer">
          <EmailSVG className={s["header-links-icons"]} width={35} height={35} />
